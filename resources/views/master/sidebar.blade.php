		...
		<div id="main-menu">
			<ul class="sidebar-nav">
				...
				@if(Auth::user()->status == 'kabag')
					<li class="{{ setCurrent('admin.book.index') }}{{ setCurrenq('admin.book.index') }}">
						<a href="{{ action('Admin\BookController@index') }}"> <i class="fa fa-book"></i> <span class="sidebar-text">Data Buku</span></a>
					</li>
					<li class="{{ setCurrent('admin.borrow.index') }}{{ setCurrent('admin.member.index') }}{{ setCurrent('admin.member.show') }}{{ setCurrenq('admin.member.index') }}{{ setCurrenq('admin.borrow.index') }}">
						<a href="{{ action('Admin\BorrowController@index') }}"> <i class="fa fa-retweet"></i> <span class="sidebar-text">Data Peminjaman</span></a>
					</li>
				@else
